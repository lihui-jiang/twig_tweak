...
class TwigTweakExtension extends AbstractExtension {
   ...
   */
  public static function drupalEntityForm(string $entity_type, ?string $id = NULL, string $form_mode = 'default', array $values = [], ?string $langcode = NULL, bool $check_access = TRUE): array {
